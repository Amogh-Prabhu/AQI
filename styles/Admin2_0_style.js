...
var style_Admin2_0 = function(feature, resolution){
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("AQI_AQI") !== null) {
        labelText = String(feature.get("AQI_AQI"));
    }
    if (value >= 61.000000 && value <= 78.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 78.000000 && value <= 107.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 107.000000 && value <= 146.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 146.000000 && value <= 191.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 191.000000 && value <= 241.000000) {
            style = [ new ol.style.Style({
